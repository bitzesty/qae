...
step "I create innovation form" do
  ...
  click_link "Save and start eligibility", href: '/new_innovation_form'
...
step "I create international trade form" do
  ...
  click_link "Save and start eligibility", href: '/new_international_trade_form'
  click_button "Continue" #eligibility step
end
...
step "I create sustainable development form" do
  ...
  click_link "Save and start eligibility", href: '/new_sustainable_development_form'
  click_button "Continue" #eligibility step
end
