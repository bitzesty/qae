...
describe Reports::FormAnswer do
  ...
  describe "user methods" do
    ...
    let(:report) { Reports::FormAnswer.new(build(:form_answer, user:)) }
  ...
  describe "#mso_grade_agreed" do
    it "should return correct grade" do
      ...
      allow_any_instance_of(Reports::FormAnswer).to receive(:pick_assignment).with("moderated") {
                                                      build(:assessor_assignment_moderated,
                                                            document: { w_rate_1: "positive", w_rate_2: "average" })
                                                    }
