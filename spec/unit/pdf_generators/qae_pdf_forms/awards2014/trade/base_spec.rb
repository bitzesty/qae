...
describe "QaePdfForms::Awards2014::Trade::Base" do
  ...
  let(:award_form) { trade_award_form_answer.award_form }
  let(:steps) { award_form.decorate.steps }

  let(:pdf_generator) do 
    trade_award_form_answer.decorate.pdf_generator
  end
  ...
  describe "PDF generation" do 
    ...
    let(:award_application_title) do
      trade_award_form_answer.decorate.award_application_title
    end
