...
RSpec.describe Admin::FormAnswerStateTransitionsController do
  ...
  describe "POST create" do
    it "should create a resource" do
      ...
      post :create, form_answer_id: form_answer.id , form_answer_state_transition: {state: 'recommended' }
      expect(response).to redirect_to [:admin, form_answer]

      xhr :post, :create, form_answer_id: form_answer.id , form_answer_state_transition: {state: 'recommended' }
