...
RSpec.describe Admin::EmailNotificationsController do
  ...
  describe "POST create" do
    it "should create a resource" do
      post :create,
           params: { email_notification: FactoryBot.attributes_for(:email_notification, formatted_trigger_at_date: Date.today.strftime("%d/%m/%Y"),
                                                                                        formatted_trigger_at_time: "1:00") }
