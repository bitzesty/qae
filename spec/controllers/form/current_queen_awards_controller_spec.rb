...
RSpec.describe Form::CurrentQueensAwardsController do
  ...
  describe "GET edit" do
    it "renders the edit template" do
      get :edit, id: '000', form_answer_id: form_answer.id, current_queens_award: { category: 'title', year: Date.today.year }
  ...
  describe "POST create" do
    it "should create a resource" do
      ...
      post :create, form_answer_id: form_answer.id, current_queens_award: { category: 'title', year: Date.today.year }
