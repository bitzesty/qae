  ...
  class << self
    def mobility_step3
      @mobility_step3 ||= proc do
        ...
        options :mobility_in_relation_to_organisation,
                "Select a statement that best describes your social mobility in relation to your whole organisation:" do
          required
          ref "C 1.1"
          classes "conditional-select-statement"

          option "discretionary_activity",
          ...
          option "joint_application_or_workforce_initiative",
        ...
        checkbox_seria :initiative_activities,
          ...
          check_options [
            ...
            ["job_opportunities",
             "<strong>Job opportunities</strong> - broadening access to job opportunities by creating accessible routes to employment. This could be by providing jobs for people from disadvantaged backgrounds who are leaving school, college, university or prisons, for example, through quality traineeships, internships, apprenticeships or graduate schemes."],
            ["advancement",
             "<strong>Advancement</strong> - developing career paths to senior positions for those from disadvantaged backgrounds and tracking the progress of employees from non-graduate routes."],
        ...
        textarea :goals_targets_monitor,
                 "Describe what goals or targets you set and how you monitor them in the context of your initiative." do
          classes "question"
          ref "C 4"
          required
          words_max 500
          ...
          pdf_context_with_header_blocks [
            [:italic,
             "Your goals or targets should be aligned with the types of activities you listed in C2 as well as the impact you will demonstrate in C5 questions."],
            [:normal,
             %(
        ...
        matrix :disadvantaged_participants_activity_type,
               "Provide the number of disadvantaged participants in each activity type that your initiative supports each year." do
          classes "sub-question question-matrix"
          ref "C 5.2"
          required
        ...
        matrix :disadvantaged_participants_in_group_year,
               "Provide the number of participants in each disadvantaged group where your initiative has resulted in employment opportunities." do
          classes "sub-question question-matrix"
          sub_ref "C 5.4"
          required
        ...
        textarea :disadvantaged_group_not_in_list,
                 "If you are putting forward a group that is not on this list, please provide details and explain why you believe the group you support should be considered disadvantaged." do
          sub_ref "C 5.4.1"
          context %(
            <p><em>
        ...
        matrix :disadvantaged_groups_impact_employment,
               "Provide the number of participants in each disadvantaged group where your initiative has resulted in educational opportunities." do
          classes "sub-question question-matrix"
          sub_ref "C 5.5"
          required
          required_rows :disadvantaged_participants, hide_unchecked: true
          ...
          x_headings ["Jobs secured during the support or within a year after support ending",
        ...
        textarea :disadvantaged_groups_impact_employment_explained,
                 "If, in question C5.5, jobs retained for more than a year are significantly lower than those secured during the support or within a year of support ending, please explain why." do
          classes "sub-question"
          sub_ref "C 5.5.1"
          required
          words_max 150
        ...
        matrix :disadvantaged_groups_impact_education,
               "Provide the number of participants in each disadvantaged group that your initiative resulted in educational opportunities for them." do
          classes "sub-question question-matrix"
          sub_ref "C 5.6"
          required
          required_rows :disadvantaged_participants, hide_unchecked: true
        ...
        matrix :disadvantaged_groups_opportunities_numbers,
               "Provide the number of participants in each disadvantaged group that your initiative resulted in other opportunities for them." do
          classes "sub-question question-matrix"
          sub_ref "C 5.7"
          required
          required_rows :disadvantaged_participants, hide_unchecked: true
        ...
        textarea :initiative_qualitative_impact,
        ...
        textarea :initiative_member_engagement,
                 "Explain if and how you engage the organisation’s members or workforce in the design and implementation of your initiative." do
          classes "sub-question"
          sub_ref "C 6.2"
          required
          words_max 200
