      ...
      @mobility_step2 ||= proc do
        ...
        options :external_contribute_to_sustainable_product, "Did any external organisations or individuals significantly contribute to your social mobility initiative?" do
          ...
          context %(
            ...
            <p>
              For example, if you collaborate with many organisations regarding your initiative, but you are leading it, you do not need to include them. However, if you partnered with one or few organisations and together designed and are delivering the initiative, then they should be included.
            </p>
          )
          yes_no
        end
