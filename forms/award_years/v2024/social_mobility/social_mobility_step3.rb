    ...
    def mobility_step3
      @mobility_step3 ||= proc do
        ...
        matrix :disadvantaged_groups_impact_employment,
               "Provide the number of participants in each disadvantaged group that your initiative has resulted in employment opportunities for them." do
          classes "sub-question question-matrix"
          sub_ref "C 5.4"
          required
          context %(
        ...
        textarea :disadvantaged_groups_impact_employment_explained,
                 "If, in question C5.4, jobs retained for more than a year are significantly lower than those secured during the support or within a year of support ending, please explain why." do
          classes "sub-question"
          sub_ref "C 5.4.1"
          required
          words_max 150
