    ...
    def trade_step3
      @trade_step3 ||= proc do
        ...
        trade_commercial_success :trade_commercial_success,
          ...
          required
          option "3 to 5",
                 "Outstanding Short-term Growth: international trade has resulted in outstanding year on year growth in the last three years with no dips"
          option "6 plus",
                 "Outstanding Continuous Growth: international trade has resulted in continuous year on year growth in the last six years with no dips"
        ...
        textarea :drops_in_turnover,
                 "Explain any drops in the total turnover or net profit, and any losses made. Sustained or unexplained losses may lead to the entry being rejected." do
