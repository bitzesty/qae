class Notifiers::EmailNotificationService
  ...
  def initialize
    ...
    return unless AwardYear.current != AwardYear.closed
  ...
  def award_year_open_notifier(_award_year)
  ...
  def submission_started_notification(_award_year, award_type)
  ...
  def buckingham_palace_invite(award_year)
    ...
    award_year.form_answers.business.winners.each do |form_answer|
      ...
      form_answer_ids << form_answer.id unless invite.submitted?
    end
