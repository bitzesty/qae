...
module PdfAuditCertificates::General::GuidanceElements
  ...
  def render_applicant_guidance_text
    ...
    p5 = "Once you and your external accountant have completed this report, please upload it to The Queen’s Awards for Enterprise online portal by #{Settings.current_audit_certificates_deadline.decorate.formatted_trigger_time(false)}. We are unable to accept late reports due to the strict assessment and judging timetable."
