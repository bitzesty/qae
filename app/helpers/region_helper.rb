module RegionHelper
  ...
  COUNTY_REGION_MAPPINGS = {
    ...
    "Lincolnshire (excluding North Lincolnshire and North East Lincolnshire)": "East Midlands",
    "Lincolnshire (North Lincolnshire and North East Lincolnshire)": "Yorkshire & The Humber",
    ...
    "North Yorkshire (Excluding: Darlington, Hartlepool, Middlesbrough, Redcar and Cleveland, Stockton-on-Tees)": "Yorkshire & The Humber",
    "North Yorkshire (Only: Darlington, Hartlepool, Middlesbrough, Redcar and Cleveland, Stockton-on-Tees)": "North East",
    ...
    "West Midlands (Includes Birmingham)": "West Midlands",
