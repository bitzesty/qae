class Eligibility::Innovation < Eligibility
  ...
  property :number_of_innovative_products, positive_integer: true, label: "How many?", accept: :not_nil, additional_label: 'How many innovative products/services/initiatives do you have?', if: proc { innovative_product.nil? || innovative_product? }
