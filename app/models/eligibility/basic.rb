class Eligibility::Basic < Eligibility
  ...
  property :industry, values: %w[product_business service_business either_business], label: "Is the part of your business you wish to enter:", accept: :not_nil_or_charity
