      ...
      @mobility_step4 ||= proc do
        header :complete_now_header, "" do
          ...
          context %(
            ...
            <p class="govuk-body">
              The Declaration of Environmental Social Governance (ESG) is a chance for you to show your responsible business conduct, including governance, and social, economic and environmental impact.
            </p>
            <p class="govuk-body">
              All applicants for a Queen's Award for Enterprise must demonstrate how they meet commonly accepted standards for Environmental Social Governance, which developed from Corporate Social Responsibility. Applicants who are not able to demonstrate Environmental Social Governance will not be successful.
            </p>
