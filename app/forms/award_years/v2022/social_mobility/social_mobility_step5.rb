      ...
      @mobility_step5 ||= proc do
        upload :innovation_materials, "If there is additional material you feel would help us to assess your entry then you can add up to 5 files or website addresses here" do
          ...
          context %(
            ...
            <p class="govuk-body">You can upload files in all common formats, as long as they're less than 5mb each. You may link to videos, websites or other media you feel relevant.</p>
