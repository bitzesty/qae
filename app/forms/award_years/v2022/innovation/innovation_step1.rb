    ...
    def innovation_step1
      @innovation_step1 ||= proc do
        ...
        text :company_name, "Full/legal name of your organisation" do
          ...
          ref "A 2"
          context %(
            <p class="govuk-body">If applicable, include 'trading as', or any other name your organisation uses/has used. Please note, if successful, we will use this name on any award materials – for example in award certificates.</p>
          )
        end
        ...
        text :registration_number, "Provide your company or charity registration number or enter 'N/A'." do
          ...
          ref "A 4.1"
          context %(
            <p class="govuk-body">If you're an unregistered subsidiary, enter your parent company's number.</p>
          )
          style "small"
        end
        ...
        textarea :other_awards_desc, "Please describe them." do
          ...
          sub_ref "A 7.1"
          required
          context %(<p class="govuk-body">If you can't fit all of your awards below, then choose those you're most proud of.</p>)
