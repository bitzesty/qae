      ...
      @development_step4 ||= proc do
        upload :innovation_materials, "If there is additional material you feel would help us to assess your entry, then you can add up to 3 files or website addresses here." do
          ...
          context %(
            ...
            <p class="govuk-body">You can upload files in all common formats, as long as they're less than 5mb each.</p>
            <p class="govuk-body">You may link to videos, websites or other media you feel relevant.</p>
            <p class="govuk-body">We won't consider business plans, annual accounts or company policy documents. Additional materials should not be used as a substitute for completing sections of the form.</p>
          )
