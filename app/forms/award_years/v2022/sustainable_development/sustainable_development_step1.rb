    ...
    def development_step1
      @development_step1 ||= proc do
        ...
        text :company_name, "Full/legal name of your organisation" do
          ...
          ref "A 2"
          context %(
            <p class="govuk-body">If applicable, include 'trading as', or any other name your organisation uses/has used. Please note, if successful, we will use this name on any award materials - e.g. award certificates.</p>
          )
        end
