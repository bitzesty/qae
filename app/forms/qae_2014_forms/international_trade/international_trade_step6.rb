    ...
    def trade_step6
      @trade_step6 ||= proc do
        ...
        submit "Submit application" do
          notice %(
            <p>
              If you've answered all the questions, you can submit your application now. You will be able to edit it any time before 23:59 on the last working day of September.
            </p>
            <p>
