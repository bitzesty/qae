  ...
  class << self
    def promotion_step5
      @promotion_step5 ||= proc do
        upload :innovation_materials, "If there is additional material you feel would help us to assess your nomination then you can add up to 4 files or links here." do
          ref "E 1"
          context %(
            <p>
