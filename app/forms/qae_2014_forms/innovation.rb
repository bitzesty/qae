  ...
  class << self
    def innovation
      @innovation ||= QAEFormBuilder.build 'Apply for the Innovation Award' do
        ...
        step 'Commercial Performance', "Commercial<br> Performance", &QAE2014Forms.innovation_step2

        step 'Description of Goods or Services', "Goods or Services", &QAE2014Forms.innovation_step3

        step 'Declaration of Corporate Responsibility', "Corporate<br> Responsibility", &QAE2014Forms.innovation_step4
